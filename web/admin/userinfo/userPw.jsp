...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type='text/javascript' src='/wlfzjx/dwr/interface/loginService.js'></script>
        <script type='text/javascript' src='/wlfzjx/dwr/engine.js'></script>
        <script type='text/javascript' src='/wlfzjx/dwr/util.js'></script>
	...
	<body leftmargin="2" topmargin="9" background='/wlfzjx/images/allbg.gif'>
			<form method="post" action="/wlfzjx/userPwEdit.action" name="formPw">
			<table width="98%" align="center" border="0" cellpadding="4" cellspacing="1" bgcolor="#CBD8AC" style="margin-bottom:8px">
				<tr bgcolor="#EEF4EA">
				    <td colspan="2" background="/wlfzjx/images/wbg.gif" class='title'><span>&nbsp;</span></td>
				</tr>
				<tr bgcolor="#FFFFFF">
				...
				<tr bgcolor="#FFFFFF">
			        ...
			        <td width="90%" bgcolor="#FFFFFF">
			             ...
			             <img id="indicator" src="/wlfzjx/images/loading.gif" alt="Loading..." style="display:none"/>
			        </td>
				</tr>
			</table>
			</form>
