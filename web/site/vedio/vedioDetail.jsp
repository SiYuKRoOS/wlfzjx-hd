...
<html>
  <head>
	...
	<script type="text/javascript" src="/wlfzjx/js/public.js"></script>
	
	<script type="text/javascript">
        function down1(path,oldName)
        {
            var url="/wlfzjx/VedioServlet?method=downloadVedio&amp;vedioAttachment="+path+"&amp;vedioOldName="+oldName;
            /* url=encodeURI(url); 
            url=encodeURI(url); */ 
        ...
        {
              var url="/wlfzjx/bofang/bofang.jsp";
  ...
  <div id="wrapper">
      ...
      <div id="footer">
	      <div id="copyright">
	        Copyright &copy; 2013 Company Name All right reserved&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="/wlfzjx/login.jsp">系统后台登陆</a>
	      </div>
