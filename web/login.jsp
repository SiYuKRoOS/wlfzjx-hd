				      ...
				      <TABLE border="0" cellSpacing="0" cellPadding="0" width="100%">
				          ...
				          <TR>
					          <TD style="HEIGHT: 13px">系统
					              ...
					              <input type="button" value="登录" style="width: 40px;" onclick='check1()'>
								  <input type="button" value="首页" style="width: 40px;" onclick='click1()'>
...
<script>
	function click1() {
	   window.location.href="/wlfzjx/site/index.jsp"
