...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
        ...
        <script language="javascript">
           function docAdd()
           {
              var url="/wlfzjx/atea/doc/docAdd.jsp";
			...
			<table width="98%" border="0" cellpadding="2" cellspacing="1" bgcolor="#D1DDAA" align="center" style="margin-top:8px">
				...
				<s:iterator value="#request.docList" id="doc" status="ss">
					<tr align='center' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='red';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
						...
						<td bgcolor="#FFFFFF" align="center">
							<a class="pn-loperator" href="/wlfzjx/docDel.action?id=<s:property value="#doc.id"/>">删除</a>
						</td>
					</tr>
				</s:iterator>
				--%>
				...
				<tr align='center' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='red';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
						...
						<td bgcolor="#FFFFFF" align="center">
							...
							<a class="pn-loperator" href="/wlfzjx/docDel.action?id=<s:property value="#doc.id"/>">删除</a>
							 --%>
							<a class="pn-loperator" href="/wlfzjx/docDel.action?id=001">删除</a>
						</td>
				 </tr>
